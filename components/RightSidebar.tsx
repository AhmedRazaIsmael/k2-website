...
export default function RightSidebar({ brands = [], prices = [] }: any) {
  return (
    <div className="hidden lg:block bg-white rounded-xl p-4">
      ...
      <div className="space-y-2 text-sm">
        {brands.map((brand: any) => (
          ...
          >
            <a href={`/cars-in-stock?brand=${brand.slug}`} className="flex gap-1 items-center">
            {/* Logo */}
            <img
              src={brand.logo_url}
              alt={brand.name}
    ...
    <hr className="my-5 h-[2px] bg-[#dee2e6] border-0" />
      ...
      <div className="space-y-2 text-sm">
        {prices.map((price: any) => (
          ...
          >
            <a href={`/cars-in-stock?min_price=${price.min}&max_price=${price.max}`} className="flex gap-2 items-center">
            {/* Logo */}
            <img
              src="/price.png"
              alt={price.label}
      ...
      <div className="space-y-2 text-sm">
          <div
            className="flex items-center gap-2 pb-1 transition"
          >
            <a href="/cars-in-stock?steering=rhd" className="flex gap-2 items-center">
            {/* Logo */}
            <img
              src="/handed.png"
              alt="Handed"
           ...
           <div
            className="flex items-center gap-2 pb-1 transition"
          >
            <a href="/cars-in-stock?steering=lhd" className="flex gap-2 items-center">
            {/* Logo */}
            <img
              src="/handed.png"
              alt="Handed"
